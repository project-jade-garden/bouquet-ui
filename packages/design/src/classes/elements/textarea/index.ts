// * Copy of input - removed 'type' variant
...
export const textareaStyles = cva(
  ...
  {
    description: "Often used for comments or messages.",
    name: "Textarea",
    see: "https://github.com/project-jade-garden/bouquet-ui/blob/main/packages/design/src/classes/elements/textarea"
  }
);

export type * as TextareaStyles from "./types";
